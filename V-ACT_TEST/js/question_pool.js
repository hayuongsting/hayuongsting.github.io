// ─── V-ACT Test Question Pool ───
const VACT_QUESTION_POOL = {
  "part1": [
    {
      "id": 1,
  ...
  "part2": [
    ...
    {
      "id": 11,
      "text": "The scientist provided us with <span class=\"underline-error\">an</span> (A) extremely useful <span class=\"underline-error\">information</span> (B) about the <span class=\"underline-error\">upcoming</span> (C) solar <span class=\"underline-error\">eclipse</span> (D).",
      "options": [
        "an",
        "information",
        "upcoming",
      ...
      "correct": 0,
      "explain": "Information là danh từ không đếm được, không dùng mạo từ 'an'. Phải bỏ 'an' hoặc thay bằng 'some'."
    },
    {
      "text": "The company focuses on <span class=\"underline-error\">produce</span> (A) <span class=\"underline-error\">environmentally</span> (B) friendly products to <span class=\"underline-error\">protect</span> (C) the <span class=\"underline-error\">nature world</span> (D).",
      "options": [
        "produce",
        "environmentally",
        "protect",
      ...
      "correct": 3,
      "explain": "Trước danh từ 'world' cần một tính từ bổ nghĩa (pre-modifier) chứ không dùng danh từ 'nature'. Sửa 'nature world' thành 'natural world'."
    },
    {
      "text": "The dog was wagging <span class=\"underline-error\">it's</span> (A) tail <span class=\"underline-error\">excitedly</span> (B) when it <span class=\"underline-error\">saw</span> (C) the owner coming <span class=\"underline-error\">home</span> (D).",
      "options": [
        "it's",
        "excitedly",
        "saw",
      ...
      "correct": 0,
      "explain": "'It's' là viết tắt của 'it is' hoặc 'it has'. Ở đây cần một tính từ sở hữu 'its' (đuôi của nó). Sửa 'it's' thành 'its'."
    },
    {
      "text": "This laptop is <span class=\"underline-error\">my</span> (A), but <span class=\"underline-error\">yours</span> (B) is over there <span class=\"underline-error\">on the</span> (C) conference <span class=\"underline-error\">table</span> (D).",
      "options": [
        "my",
        "yours",
        "on the",
      ...
      "correct": 0,
      "explain": "Đứng độc lập làm vị ngữ không có danh từ theo sau phải dùng đại từ sở hữu 'mine'. Sửa 'my' thành 'mine'."
    },
    {
      "text": "This secret must <span class=\"underline-error\">remain</span> (A) strictly <span class=\"underline-error\">between</span> (B) you and <span class=\"underline-error\">I</span> (C) for the time <span class=\"underline-error\">being</span> (D).",
      "options": [
        "remain",
        "between",
        "I",
      ...
      "correct": 2,
      "explain": "Đứng sau giới từ 'between' phải dùng đại từ tân ngữ. Sửa 'I' thành 'me' (between you and me)."
    },
    {
      "id": 6,
    ...
    {
      "text": "The school library has <span class=\"underline-error\">every</span> (A) books <span class=\"underline-error\">written by</span> (B) this author, which is <span class=\"underline-error\">great</span> (C) for our <span class=\"underline-error\">research</span> (D).",
      "options": [
        "every",
        "written by",
        "great",
      ...
      "correct": 0,
      "explain": "Books là danh từ số nhiều, trong khi 'every' đi với danh từ số ít. Sửa 'every' thành 'all' hoặc 'each of the'."
    },
    {
      "text": "She was wearing <span class=\"underline-error\">an elegant</span> (A) <span class=\"underline-error\">silk yellow</span> (B) dress <span class=\"underline-error\">at the</span> (C) charity gala last <span class=\"underline-error\">night</span> (D).",
      "options": [
        "an elegant",
        "silk yellow",
        "at the",
      ...
      "correct": 1,
      "explain": "Trật tự của tính từ/danh từ bổ nghĩa trước danh từ chính (silk yellow dress): Màu sắc (yellow) đứng trước chất liệu (silk) -> 'yellow silk dress'."
    },
    {
      "text": "Each member of the <span class=\"underline-error\">committee</span> (A) has <span class=\"underline-error\">their</span> (B) own opinion on <span class=\"underline-error\">how to solve</span> (C) the economic crisis <span class=\"underline-error\">effectively</span> (D).",
      "options": [
        "committee",
        "their",
        "how to solve",
      ...
      "correct": 1,
      "explain": "'Each member' là chủ ngữ số ít, do đó phải dùng tính từ sở hữu số ít 'his or her' (hoặc 'his/her') thay vì 'their'. Sửa 'their' thành 'his or her'."
    },
    {
      "text": "Our house is <span class=\"underline-error\">much smaller</span> (A) than <span class=\"underline-error\">their</span> (B), but we have a <span class=\"underline-error\">larger</span> (C) garden for children to <span class=\"underline-error\">play</span> (D).",
      "options": [
        "much smaller",
        "their",
        "larger",
      ...
      "correct": 1,
      "explain": "Ở đây so sánh nhà của chúng tôi với nhà của họ (their house). Không có danh từ 'house' đi kèm ở vế sau, ta phải dùng đại từ sở hữu 'theirs'. Sửa 'their' thành 'theirs'."
    },
    {
      "text": "The principal <span class=\"underline-error\">invited</span> (A) my colleagues and <span class=\"underline-error\">he</span> (B) to attend the <span class=\"underline-error\">annual</span> (C) teacher <span class=\"underline-error\">conference</span> (D).",
      "options": [
        "invited",
        "he",
        "annual",
      ...
      "correct": 1,
      "explain": "Đóng vai trò tân ngữ đứng sau động từ 'invited' phải dùng đại từ tân ngữ. Sửa 'he' thành 'him'."
    },
    {
      "id": 6,
    ...
    {
      "text": "I borrowed <span class=\"underline-error\">a this</span> (A) book <span class=\"underline-error\">from the</span> (B) teacher to prepare <span class=\"underline-error\">for</span> (C) my upcoming English exam <span class=\"underline-error\">next week</span> (D).",
      "options": [
        "a this",
        "from the",
        "for",
      ...
      "correct": 0,
      "explain": "Không dùng hai từ hạn định đứng cạnh nhau (mạo từ 'a' và từ chỉ định 'this'). Sửa bằng cách bỏ 'a'."
    },
    {
      "text": "The school board <span class=\"underline-error\">approved</span> (A) the construction of a new <span class=\"underline-error\">sciences lab</span> (B) to enhance <span class=\"underline-error\">practical learning</span> (C) for <span class=\"underline-error\">their students</span> (D).",
      "options": [
        "approved",
        "sciences lab",
        "practical learning",
      ...
      "correct": 1,
      "explain": "Khi danh từ làm bổ ngữ cho danh từ khác (noun adjunct), nó thường ở dạng số ít. Sửa 'sciences lab' thành 'science lab'."
    },
    {
      "text": "<span class=\"underline-error\">He</span> (A) parents were <span class=\"underline-error\">very proud</span> (B) of <span class=\"underline-error\">his</span> (C) achievements in the final <span class=\"underline-error\">examination</span> (D).",
      "options": [
        "He",
        "very proud",
        "his",
      ...
      "correct": 0,
      "explain": "Đứng trước danh từ 'parents' cần một tính từ sở hữu. Sửa 'He' thành 'His'."
    },
    {
      "text": "A friend of <span class=\"underline-error\">mine's</span> (A) will <span class=\"underline-error\">visit</span> (B) me this weekend <span class=\"underline-error\">to study</span> (C) for the exam <span class=\"underline-error\">together</span> (D).",
      "options": [
        "mine's",
        "visit",
        "to study",
      ...
      "correct": 0,
      "explain": "Cấu trúc sở hữu kép là 'a friend of mine' (một người bạn của tôi). Không thêm sở hữu cách ''s' sau 'mine'. Sửa 'mine's' thành 'mine'."
    },
    {
      "text": "The manager <span class=\"underline-error\">warned</span> (A) the new employees and <span class=\"underline-error\">they</span> (B) not to leave <span class=\"underline-error\">the office</span> (C) without <span class=\"underline-error\">permission</span> (D).",
      "options": [
        "warned",
        "they",
        "the office",
      ...
      "correct": 1,
      "explain": "Làm tân ngữ trực tiếp cho động từ 'warned', phải dùng đại từ tân ngữ 'them'. Sửa 'they' thành 'them'."
    },
    {
      "id": 6,
    ...
    {
      "text": "We had <span class=\"underline-error\">a</span> (A) wonderful holiday <span class=\"underline-error\">climbing</span> (B) <span class=\"underline-error\">the Mount Everest</span> (C) in <span class=\"underline-error\">the Himalayas</span> (D) last summer.",
      "options": [
        "a",
        "climbing",
        "the Mount Everest",
      ...
      "correct": 2,
      "explain": "Không dùng mạo từ 'the' trước tên các ngọn núi đơn lẻ (Mount Everest). Sửa 'the Mount Everest' thành 'Mount Everest'."
    },
    {
      "text": "They went on <span class=\"underline-error\">a</span> (A) <span class=\"underline-error\">three-weeks</span> (B) holiday to explore <span class=\"underline-error\">the beautiful</span> (C) landscapes of <span class=\"underline-error\">Vietnam</span> (D).",
      "options": [
        "a",
        "three-weeks",
        "the beautiful",
      ...
      "correct": 1,
      "explain": "Tính từ ghép (compound adjective) có dạng số-danh từ bổ nghĩa cho danh từ chính (holiday) không dùng dạng số nhiều. Sửa 'three-weeks' thành 'three-week'."
    },
    {
      "text": "The teacher <span class=\"underline-error\">who's</span> (A) classroom <span class=\"underline-error\">was flooded</span> (B) had to <span class=\"underline-error\">move</span> (C) the students to the <span class=\"underline-error\">library</span> (D).",
      "options": [
        "who's",
        "was flooded",
        "move",
      ...
      "correct": 0,
      "explain": "'Who's' là viết tắt của 'who is' hoặc 'who has'. Ở đây cần một đại từ quan hệ chỉ sở hữu bổ nghĩa cho danh từ 'classroom'. Sửa 'who's' thành 'whose'."
    },
    {
      "text": "Although <span class=\"underline-error\">yours</span> (A) car is <span class=\"underline-error\">newer than</span> (B) mine, it is <span class=\"underline-error\">not as</span> (C) fuel-efficient <span class=\"underline-error\">as</span> (D) mine.",
      "options": [
        "yours",
        "newer than",
        "not as",
      ...
      "correct": 0,
      "explain": "Đứng trước danh từ 'car' phải dùng tính từ sở hữu 'your', không dùng đại từ sở hữu 'yours'. Sửa 'yours' thành 'your'."
    },
    {
      "text": "The book <span class=\"underline-error\">which</span> (A) the teacher <span class=\"underline-error\">recommended</span> (B) <span class=\"underline-error\">it</span> (C) was very hard <span class=\"underline-error\">to understand</span> (D).",
      "options": [
        "which",
        "recommended",
        "it",
      ...
      "correct": 2,
      "explain": "Đại từ quan hệ 'which' đã đóng vai trò tân ngữ cho động từ 'recommended', do đó không dùng thêm đại từ tân ngữ 'it' ở vế sau nữa. Sửa bằng cách bỏ 'it'."
    },
    {
      "id": 6,
  ...
  "part3": [
    ...
    {
      "text": "Jack bought the new camera from the local store yesterday.",
      "options": [
        "It was Jack who bought the new camera from the local store yesterday.",
        "It was Jack whom bought the new camera from the local store yesterday.",
        "It was yesterday which Jack bought the new camera from the local store.",
        "It was the local store who Jack bought the new camera from yesterday."
      ],
      "correct": 0,
      "explain": "Câu chẻ nhấn mạnh chủ ngữ (Jack): 'It is/was + Subject + who/that + V'. Do hành động ở quá khứ (bought) nên dùng 'It was'."
    },
    {
      "id": 12,
    ...
    {
      "text": "We didn't start the online meeting until all participants arrived.",
      "options": [
        "It was only when all participants arrived that we started the online meeting.",
        "It was not until all participants arrived when we started the online meeting.",
        "Only when all participants arrived we started the online meeting.",
        "It was until all participants arrived that we didn't start the online meeting."
      ],
      "correct": 0,
      "explain": "Câu chẻ nhấn mạnh trạng ngữ chỉ thời gian (only when...): 'It was only when + Clause + that + Clause'. Lưu ý: sau 'Not until' / 'Only when' đầu câu chẻ dùng 'that', không dùng đảo ngữ như câu thường."
    },
    {
      "id": 12,
    ...
    {
      "text": "My sister loves the chocolate cake from this bakery most.",
      "options": [
        "It is the chocolate cake from this bakery that my sister loves most.",
        "It is my sister whom the chocolate cake from this bakery loves most.",
        "What my sister loves most are the chocolate cake from this bakery.",
        "It is the chocolate cake from this bakery who my sister loves most."
      ],
      "correct": 0,
      "explain": "Câu chẻ nhấn mạnh tân ngữ (the chocolate cake...): 'It is/was + Object + that/which + S + V'. Chủ ngữ là số ít (cake) nên đi với 'is'."
    },
    {
      "id": 12,
    ...
    {
      "text": "The scientists discovered the rare plant species in this deep valley.",
      "options": [
        "It was in this deep valley that the scientists discovered the rare plant species.",
        "It was in this deep valley where the scientists discovered the rare plant species.",
        "In this deep valley was the scientists discovered the rare plant species.",
        "It was this deep valley which the scientists discovered the rare plant species in it."
      ],
      "correct": 0,
      "explain": "Câu chẻ nhấn mạnh trạng ngữ chỉ nơi chốn (in this deep valley): 'It is/was + Prepositional Phrase + that + S + V'. Chú ý dùng 'that', không dùng 'where' trong câu chẻ chính quy."
    },
    {
      "id": 12,
    ...
    {
      "text": "We need a clear strategy to expand our business, not more money.",
      "options": [
        "What we need to expand our business is a clear strategy, not more money.",
        "It is a clear strategy what we need to expand our business, not more money.",
        "What do we need to expand our business is a clear strategy, not more money.",
        "Which we need to expand our business is a clear strategy, not more money."
      ],
      "correct": 0,
      "explain": "Câu chẻ dạng Pseudo-cleft (câu chẻ với What): 'What + S + V + is/was + Noun/Phrase'."
    },
    {
      "id": 12,
