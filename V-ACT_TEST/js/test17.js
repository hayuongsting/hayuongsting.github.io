  ...
  parts: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["awake", "awoke", "woken", "awaken"],
          correct: 0,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["accepting", "avoiding", "strengthening", "stopping"],
          correct: 1,
        ...
        },
        {
          ...
          options: ["make different", "make uniform", "translate", "destroy"],
          correct: 1,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["fun activity", "routine task", "school exam", "long walk"],
          correct: 1,
        ...
        },
        {
          ...
          options: ["unimportant choice", "urgent duty", "difficult math problem", "scientific suggestion"],
          correct: 1,
